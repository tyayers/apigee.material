...
@Component({
  selector: 'app-apis-sidenav',
  templateUrl: './apis-sidenav.html',
  styleUrls: ['./apis-sidenav.scss'],
  encapsulation: ViewEncapsulation.None,
})
export class ApisSidenav implements OnInit, OnDestroy {
...
@Component({
  selector: 'app-apis-nav',
  templateUrl: './apis-nav.html',
  animations: [
...
const routes: Routes = [{
  path: '',
  component: ApisSidenav,
  children: [
    {path: 'apis/:id', redirectTo: ':id', pathMatch: 'full'},
    {path: 'apis/:id', redirectTo: '/apis/:id', pathMatch: 'full'},
    {
      path: 'apis',
      children: [
        {path: '', component: ApisSidenav},
      ],
    },
    {
      path: ':id',
...
@NgModule({
  ...
  exports: [ApisSidenav],
  declarations: [ApisSidenav, ApisNav],
  providers: [DocumentationItems],
})
export class ApisSidenavModule {}
